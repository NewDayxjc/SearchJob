...
<%@ page import="SearchJob.service.EmployeeService" %>
<%@ page import="SearchJob.pojo.Employee" %>
...
<div class="nr">  
          <div class="bft_f">
            ...
            <div class="bft_f_2">
            	<ul>
                	<li><span>
                    ${list.employee.empJobName}</span></li>
                    <li><span></span></li>
                    <li><fmt:formatDate value="${list.mesaDate}" pattern="yyyy-MM-dd : HH:mm:ss"/></li>

                    <li><a href="ToUserMessageDetail?mesaId=${list.mesaId}&&empId=${list.empId}">查看详情</a></li>
                </ul>
            </div>
              </c:forEach>
