...
<div class="top">
    ...
    <div class="top_bg">
    	<div class="top_bga">
            ...
            <div class="top_bga_2">
            	<ul>
                    <a href="getAllMessageByUserId?userId=${user.userId}"><li>个人简历</li></a>
                    <a href="bz.html"><li>联系建议</li></a>
...
<div class="nr">
    ...
    <div class="bang">
    	<!-- 标签切换开始 -->
        <div class="dengluh">尊敬的<span>${user.userAccount}用户</span></div>
        <div class="zhuce_dl">
                    	<div class="zhuce_name">
                            ...
                            <div class="zhuce_nam"><a href="exitAll">退出</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="/modify">修改密码</a></div>
                        </div>
                    </div>
        <!-- 标签切换结束 -->
    </div>
