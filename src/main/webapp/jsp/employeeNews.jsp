...
<table width="600" border="1" cellspacing="1" cellpadding="1">
  ...
  <tr>
    <td>招聘人数：${employee.empNumber}</td>
    <td>最低学历：${employee.eduName}</td>
  </tr>
  <tr>
    <td>工作经验：${employee.empExperience}</td>
    <td>年龄：${employee.empAge}</td>
  </tr>
  <tr>
    <td>工作地点：${employee.empArea}</td>
  </tr>
  <tr>
    <td>联系电话：<i>${employee.empPhone}</i></td>
  </tr>
  <tr>
    <td>联系人：${employee.empPeople}
                ...
                <div class="zzy_4">
                	<ul>
                		<a href="ToInsertMessage?compId=${employee.compId}"><li>申请职位</li></a>
                    </ul>
                </div>
                <div class="zzy_5">
