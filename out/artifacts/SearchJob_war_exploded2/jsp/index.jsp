...
<div class="top">
    ...
    <div class="top_bg">
    	<div class="top_bga">
            ...
            <div class="top_bga_2">
            	<ul>
                    <a href="contactAdvice"><li>联系建议</li></a>
                    <a href="jsp/bj.jsp"><li>招聘信息</li></a>
                    <a href="jsp/bft.jsp"><li>帮分舵</li></a>
	...
	<div class="center_b">
    	<div class="center_gg">
        	<div class="center_gga">
                ...
                <div class="more"><a href="moreNews">更多>></a></div>
            </div>
            <div class="center_ggb">
            	<ul>
                    <c:forEach items="${allEmployees}" var="list" begin="0" end="7">

                	<li><a href="employeeDetail?empId=${list.empId}"><span><fmt:formatDate value="${list.empDate}" pattern="yyyy-MM-dd : HH:mm:ss"/></span>${list.empName}</a></li>
                    </c:forEach>
            ...
            <div class="banner">
                ...
                <div class="main_visual">
                	...
                	<div class="main_image">
                		<ul>
                			<a href="zzy.jsp"><li><span class="img_1"></span></li></a>
                			<a href="zzy.jsp"><li><span class="img_2"></span></li></a>
                			<a href="zzy.jsp"><li><span class="img_3"></span></li></a>
                			<a href="zzy.jsp"><li><span class="img_4"></span></li></a>
                		</ul>
...
<div class="nr">
	<div class="newPos">
        ...
        <div class="newPos_c">
        	<ul>
            	<a href="zzy.jsp"><li><span>11-6 08：24</span>· 家过年一赚点小一赚点</li></a>
                <a href="zzy.jsp"><li><span>11-6 08：24</span>· 家过年一赚点小一赚点</li></a>
                <a href="zzy.jsp"><li><span>11-6 08：24</span>· 家过年一赚点小一赚点</li></a>
            </ul>
        </div>
    ...
    <div class="bang">
        ...
        <div class="itab">
        	<dl class="slideBox">
        		<dt>
        			<span style="width:162px">个人用户</span>
        			<span style="width:162px; border-left:1px solid #fff; border-right:1px solid #fff;">企业用户</span>
                    <span style="width:162px">管理员</span>
        		</dt>
                	...
                	<div class="zhuce">
                    	<div class="zhuce_name">
                            ...
                            <form action="/login" method="post">
                                <div class="zhuce_nam"><input type="text" name="userAccount" /></div>
                                <div class="zhuce_balnk1"></div>
                                <div class="zhuce_nam"><input type="password"  name="userPwd"/></div>
                                <div class="zhuce_balnk2"></div>
                                <div class="zhuce_nam1"><input type="text" /></div>
                                <div class="zhuce_nam2"><a href=""><img src="images/yzm.jpg" /></a></div>
                                <div class="zhuce_nam"><input type="submit" value="登录" height="50dp"></a>
                                </div>
                            </form>
                            <div><a href="jsp/wjmm.jsp" style="color: #f1f1f1">忘记密码？</a>
                                <a href="register" style="color: #f1f1f1">注册用户</a></div>
                        </div>
                    </div>
                </dd>
                <dd>
                	<div class="zhuce1">
                    	<div class="zhuce_name">
                            <div class="zhuce_balnk"></div>
                            <form action="/companyLogin?compId=${company.compId}" method="post || get">
                                <div class="zhuce_nam"><input type="text" name="compAccount" /></div>
                                <div class="zhuce_balnk1"></div>
                                <div class="zhuce_nam"><input type="password"  name="compPwd"/></div>
                                <div class="zhuce_balnk2"></div>
                                <div class="zhuce_nam1"><input type="text" /></div>
                                <div class="zhuce_nam2"><a href=""><img src="images/yzm.jpg" /></a></div>
                                <div class="zhuce_nam"><input type="submit" value="登录" height="50dp"></a>
                            ...
                            <div><a href="jsp/wjmm.jsp" style="color: #f1f1f1">忘记密码？</a>
                                <a href="companyRegister" style="color: #f1f1f1">注册用户</a></div>
                ...
                <dd>
                	<div class="zhuce">
                    	<div class="zhuce_name">
                            ...
                            <div class="zhuce_nam"><input type="text" name="adminName" /></div>
                            <div class="zhuce_balnk1"></div>
                            <div class="zhuce_nam"><input type="password"  name="adminPwd"/></div>
                            <div class="zhuce_balnk2"></div>
                            <div class="zhuce_nam1"><input type="text" /></div>
                            <div class="zhuce_nam2"><a href=""><img src="images/yzm.jpg" /></a></div>
                            <div class="zhuce_nam"><input type="submit" value="登录" height="50dp"></a>
                            ...
                            <div><a href="jsp/wjmm.jsp" style="color: #f1f1f1">忘记密码？</a><a href="jsp/zc.jsp" style="color: #f1f1f1">注册用户</a></div>
                        </div>
                    </div>
                </dd>
             </dl>
	...
	<div class="bz">
        ...
        <div class="bz_a">
            ...
            <div class="bz_a_2">
            	<ul>
                	<li><a href="bft_more.jsp">地板、面砖的铺设 </a></li>
                    <li><a href="bft_more.jsp">粉刷工</a></li>
                    <li><a href="bft_more.jsp">油漆工</a></li>
                </ul>
            </div>
        </div>
        <div class="bz_a">
	...
	<div class="button">
        ...
        版权所有© 兼职网 2014-2020      豫88888888号 More Templates <a href="http://www.cssmoban.com/" target="_blank" title="模板之家">模板之家</a> - Collect from <a href="http://www.cssmoban.com/" title="网页模板" target="_blank">网页模板</a>
	</div>
	<!-- 底部内容结束 -->
