...
<div class="nr">
    ...
    <div class="bzz">
    	<div class="center_gga">
			<div class="center_gga_1">&nbsp;修改密码</div>
		</div>
        <div class="zc_a">
        	<div class="zc_left"><img src="images/zc_1.jpg" usemap="#Map" border="0" />
              <map name="Map" id="Map">
            ...
            <div class="zc_right">
                ...
                <form action="/UpdateCompany?compId=${company.compId}" method="post">
                    <div style="background: red">${message}</div>

                    <div class="item">
                        <label>公司名：</label>
                        <input type="text" name="compName" value="${company.compName}"/>
                    </div>
                    <div ><a href="/updateCompanyPwd">修改密码</a> </div>
                    <div class="item">
                        <label>公司地点：</label>
                        <input type="text" name="compArea" value="${company.compArea}"/>
                    </div>
                    <div class="item">
                        <label>公司法人：</label>
                        <input type="text" name="compManager" value="${company.compManager}"/>
                    </div>
              <div class="item_b">
              	<div class="item_b_1"></div>
              	<input type="submit" value="确定" style="">
              </div>
                </form>
          </div>
        </div>
