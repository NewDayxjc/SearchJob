            ...
            <div class="bfd_banner">
                ...
                <div class="main_visual_a">
                	...
                	<div class="main_image_a">
                		<ul>
                			<li><a href="zzy.html"><span class="img_5"></span></a></li>
                			<li><a href="zzy.html"><span class="img_6"></span></a></li>
                			<li><a href="zzy.html"><span class="img_7"></span></a></li>
                			<li><a href="zzy.html"><span class="img_8"></span></a></li>
                            <li><a href="zzy.html"><span class="img_9"></span></a></li>
                		</ul>
				...
				<li>
					...
					<ul class="submenu">
        				...
        				<div class="bft_e">
							...
							<input type='hidden' name='' class='diy_select_input'/>
							<div class='diy_select_txt'>生活服务</div>
							<div class='diy_select_btn'></div>
								<ul class='diy_select_list'>
									<li>销售</li>
									<li>技工</li>
                            ...
                            <div class='diy_select'>
							<input type='hidden' name='' class='diy_select_input'/>
							<div class='diy_select_txt'>时段</div>
							<div class='diy_select_btn'></div>
								<ul class='diy_select_list'>
									<li>电话销售</li>
									<li>餐厅经理</li>
                            ...
                            <div class='diy_select'>
							<input type='hidden' name='' class='diy_select_input'/>
							<div class='diy_select_txt'>优惠信息</div>
							<div class='diy_select_btn'></div>
								<ul class='diy_select_list'>
									<li>10-30元/小时</li>
									<li>150元/天</li>
