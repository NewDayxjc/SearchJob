...
<div class="nr">
    ...
    <div class="bzz">
        ...
        <div class="zc_a">
        	<div class="zc_left"><img src="images/zc_2.jpg" usemap="#Map" border="0" />
              <map name="Map" id="Map">
            ...
            <div class="zc_right">
                <form action="companyLogin" id="login" method="post" >
            	<div class="item_c">
    				<label>用户名/邮箱/手机号</label>
 				</div>
                <div class="item">
   				  <input type="text" name="compAccount" />
 				</div>
              <div class="item_c">
    				<label>密&nbsp;码：</label>
 				</div>
              ...
              <div class="item_d">
              	<input type="checkbox" />&nbsp;下次自动登录(公共场所请勿勾选)
              </div>
              <div class="item_b">
